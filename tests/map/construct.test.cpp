...
int main( void ) {
	...
	std::map<std::string, int> itb(b.begin(), b.end());
	for (std::map<std::string, int>::const_iterator it = itb.begin(); it != itb.end(); it++)
	{
	...
	std::map<std::string, int, std::greater<std::string> > rb( comp, alloc );
	...
	for (std::map<std::string, int, std::greater<std::string> >::const_iterator it = rb.begin(); it != rb.end(); it++)
	{
		std::cout << it->first << std::endl;
	}

	std::cout << "<-----------{copy constructor}----------->" << std::endl;
	std::map<std::string, int> cb( itb );
	for (std::map<std::string, int>::const_iterator it = cb.begin(); it != cb.end(); it++)
	{
	...
	b = cb;
	for (std::map<std::string, int>::const_iterator it = b.begin(); it != b.end(); it++)
	{
		std::cout << it->first << ":"<< it->second << std::endl;
	}
