...
int main( void ) {
    ...
    std::cout << sizeof( ft::map<std::string, int>::const_iterator::iterator_category ) << std::endl;
    std::cout << sizeof( ft::map<std::string, int>::const_iterator::value_type ) << std::endl;
    std::cout << sizeof( ft::map<std::string, int>::const_iterator::difference_type ) << std::endl;
    std::cout << sizeof( ft::map<std::string, int>::const_iterator::pointer ) << std::endl;
    std::cout << sizeof( ft::map<std::string, int>::const_iterator::reference ) << std::endl;
