...
int main( void ) {
    ...
    ft::vector<std::string> t( static_cast<std::size_t>(5), "aa" );
    ft::vector<std::string> to( static_cast<std::size_t>(5), "aa" );
    ...
    ft::vector<int> tint( static_cast<std::size_t>(5), 10 );
    ft::vector<int> toint( static_cast<std::size_t>(5), 10 );
